        ...
        <div className="min-h-screen flex">
            {/* <section className="text-gray-600 body-font overflow-hidden m-auto"> */}
                {/* <div className="container px-5 py-11 mx-auto"> */}
                    <div className="lg:w-4/5 border-4 mx-auto sm:flex flex-wrap lg:flex-nowrap justify-center items-center">
                        {/* Image Section */}
                        <div className="border-4 w-full sm:w-1/2">
                        <Image
                            alt="ecommerce"
                            src={product.imag}
                            className="w-full h-full object-cover object- rounded"
                        />
                        </div>
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex my-10 items-center gap-2">
                                ...
                                <button onClick={() => addItem(product)} className="flex ml-auto text-white bg-indigo-500 border-0 w-24 p-2 justify-center items-center focus:outline-none hover:bg-indigo-600 rounded">
